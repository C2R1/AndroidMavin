========================================================================
   APPLICATION CONSOLE : Vue d'ensemble du projet projetKinect
========================================================================

AppWizard a créé cette application projetKinect pour vous.

Ce fichier contient un résumé des éléments contenus dans chaque fichier qui
constitue votre application projetKinect.


projetKinect.vcxproj
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) nommé projetKinect.pch et un fichier de types précompilés 
    nommé StdAfx.obj.
